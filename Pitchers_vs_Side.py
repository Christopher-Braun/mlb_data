...
pitcher_vs_side = pd.concat([name_hand, pitcher_vs], axis=1)
pitcher_cols = list(pitcher_vs_side.columns)

pitcher_vs_side['G_SIDE']=pitcher_vs_side['G_SIDE'].astype('int')
...
for pit in pit_int:
    pitcher_vs_side[pit] = pitcher_vs_side[pit].astype(int)
for pit in pit_float:
    pitcher_vs_side[pit] = pitcher_vs_side[pit].astype(float)


pitcher_vs_side['BASES_VS_AB'] = (pitcher_vs_side['1B_SIDE'] + pitcher_vs_side['2B_SIDE']*2 + pitcher_vs_side['3B_SIDE']*3 + pitcher_vs_side['HR_SIDE']*4 + pitcher_vs_side['BB_SIDE']) / pitcher_vs_side['PA_SIDE']
pitcher_vs_side = pitcher_vs_side.drop(columns = 'YEAR_SIDE')
...
pitcher_vs_side.columns = de_cols


pitcher_vs_side.to_csv('C:/Users/mrcrb/source/repos/MLB/pitcher_vs_side.csv', sep=',', encoding='utf-8')
pitcher_vs_side.to_csv('MLB/pitcher_vs_side.csv', sep=',', encoding='utf-8')
