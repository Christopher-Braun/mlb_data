...
pitcher_vs_right.loc[:,['G_RIGHT', 'PA_RIGHT', 'AB_RIGHT', 'H_RIGHT', '1B_RIGHT', '2B_RIGHT', '3B_RIGHT', 'HR_RIGHT', 'TB_RIGHT', 'SO_RIGHT', 'BB_RIGHT', 'HBP_RIGHT', 'SF_RIGHT', 'SH_RIGHT', 'DP_RIGHT']]=pitcher_vs_right.loc[:,['G_RIGHT', 'PA_RIGHT', 'AB_RIGHT', 'H_RIGHT', '1B_RIGHT', '2B_RIGHT', '3B_RIGHT', 'HR_RIGHT', 'TB_RIGHT', 'SO_RIGHT', 'BB_RIGHT', 'HBP_RIGHT', 'SF_RIGHT', 'SH_RIGHT', 'DP_RIGHT']].astype('int')
...
pitcher_vs_right['BASES_VS_AB'] = (pitcher_vs_right['1B_RIGHT'] + pitcher_vs_right['2B_RIGHT']*2 + pitcher_vs_right['3B_RIGHT']*3 + pitcher_vs_right['HR_RIGHT']*4 + pitcher_vs_right['BB_RIGHT']) / pitcher_vs_right['PA_RIGHT']
...
for col in pitcher_cols:
    if col != 'NAME' and col != 'TEAM' and col != 'NAME_TEAM':
        de_cols.append(col+'_pitcher_Std')
    else:
        de_cols.append(col)
        
pitcher_vs_right.columns = de_cols

pitcher_vs_right.to_csv('C:/Users/mrcrb/source/repos/MLB/pitcher_vs_right1.csv', sep=',', encoding='utf-8')
pitcher_vs_right.to_csv('MLB/pitcher_vs_right1.csv', sep=',', encoding='utf-8')
